...
class Task: Object {
    ...
    private let performedType = RealmOptional<Int>()
...
extension Task {
    ...
    var performedTaskType: PerformedTaskType? {
        get {
            PerformedTaskType(rawValue: performedType.value ?? .zero)
        }
        set {
            performedType.value = newValue?.rawValue
        }
    }
